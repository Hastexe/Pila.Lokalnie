...
namespace MajsterFinale.Models
{
    ...
    public partial class USERS
    {
        ...
        ErrorMessage = "Has≥o nie moøe byÊ krÛtsze niø  znakÛw. Musi zawieraÊ dodatkowo przynajmniej 1 cyfre, znak specjalny oraz duøπ literÍ.")]
        [StringLength(300, MinimumLength = 8, ErrorMessage = "Has≥o musi sk≥adaÊ sie z minumum 8 znakÛw")]
        public string REGISTERPASSWORD { get; set; }
        [DisplayName("Has≥o")]
        [DataType(DataType.Password)]
        [StringLength(300, MinimumLength = 6, ErrorMessage = "Has≥o musi sk≥adaÊ sie z minumum 6 znakÛw")]
